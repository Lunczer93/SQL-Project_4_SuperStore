...
-- Running TOtal / Running Difference month. quarter, year 

-- Sales year by year, month by month, quarters by quarters, weekday
-- Running total and Running difference by Sales + week number
