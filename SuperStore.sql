...
--Return the first of 10 Orders (Product Name) for evey customer that purchased more than 90 times.
...
-- Return the first of 3 Orders and Product names for every customer that purchased more than 5 times on May 
...
-- Return the first of 3 Orders and Product name for every customer that purchased more than 5 times on January 
...
-- Return all Orders from any customers who made less than 10000  in purchased for their first three transactions
...
-- Return all Orders from any customers who made more than 100 000  in purchased for their first three transactions
...
-- Look for the first and last Profit for each day of every months of every year including every single details (MODIFY IT!!)
...
-- The Margin (%) in each year and for category
...
-- The average value of orders in each year and for category
SELECT [Category],[2011],[2012],[2013],[2014]
FROM
(
...
-- The percentage cost of product (%) to the Sales
SELECT [Category],[2011],[2012],[2013],[2014]
FROM
(
