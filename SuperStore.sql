...
-- Rank percetange and cumu distrubution here ! ntile, discount?
-- sales profit 
-- greatest lowest sales and profit from all counteries 
--1. Which sub category is the best from category
--2. Which Product Name is the best from sub category
--3. Which Product Name is the best from  Category
...
SELECT DISTINCT [Category], [Product Name]
FROM [Project4].[dbo].[SuperStore]
ORDER BY [Category] DESC

SELECT DISTINCT [Sub-Category], [Product Name]
FROM [Project4].[dbo].[SuperStore]
