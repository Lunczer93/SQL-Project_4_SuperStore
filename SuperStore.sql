...
SELECT dbo.PercentageOfRegion(10,5)
...
--4.j) The Quantity of Orders by Sub-Category-- using scalar function to calcualte percetange!!
...
-- SALES and profit YEAR by year and month over month of each category and ranking etc
-- which product most shipping cost, sales , profit and from which subcategory - productname makign ranking of it
-- from which sub category we have the most sales profit product name and from which category we have the best sub category and so on
-- sales profit
-- using new one!!
-- 
