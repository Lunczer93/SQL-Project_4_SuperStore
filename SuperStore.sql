...
-- COMPARE CITY  SHIPPING COST AND PROFIT AND SALES by cty/ country !!!
...
-- Quantity of Orders by Country in Quarter Period
...
---- Quantity of Orders by Country in Quarter Period in 2011
SELECT [Country], 
		COALESCE([1],0) as Q1,
		COALESCE([2],0) as Q2,
		COALESCE([3],0) as Q3,
...
---- Quantity of Orders by Country in Quarter Period in 2012
SELECT [Country], 
		COALESCE([1],0) as Q1,
		COALESCE([2],0) as Q2,
		COALESCE([3],0) as Q3,
...
---- Quantity of Orders by Country in Quarter Period in 2013
SELECT [Country], 
		COALESCE([1],0) as Q1,
		COALESCE([2],0) as Q2,
		COALESCE([3],0) as Q3,
...
---- Quantity of Orders by Country in Quarter Period in 2014
SELECT [Country], 
		COALESCE([1],0) as Q1,
		COALESCE([2],0) as Q2,
		COALESCE([3],0) as Q3,
...
-- Try to combine these PIVOT by CTE to all tables in one table (years)


--4.g) The Quantity of Orders by Market-- give it percetnage?? only profit, shipping cost and sales
---- Pivot by Category and Order Priority
--make it pivot and year by year, and month by month and by quarter profit and sales
-- do the same with market and Region
...
---- Pivot by Category and Order Priority
--make it pivot and year by year, and month by month profit and sales
-- do the same with market and Region
